...
interface CoordinatorEditMentorModalProps {
    open: boolean;
    onCancel: () => void;
    mentor: any;
    refetch: () => void;
...
const CoordinatorEditMentorModal: React.FC<CoordinatorEditMentorModalProps> = ({
    open,
    onCancel,
    mentor,
    refetch,
    ...
    return (
        <Modal
            title={<span className="text-xl font-semibold text-[#18212d]">Edit Mentor Profile</span>}
            open={open}
            onCancel={onCancel}
            footer={null}
            closeIcon={<X size={20} />}
...
export default CoordinatorEditMentorModal;
